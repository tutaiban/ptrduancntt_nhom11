...
<body>
<section>
    <h2>Đơn hàng <form action ="admin.php?act=timkiemdonhang" method ="post">
        <input style="width:300px" type="text" name="kyw" placeholder="tìm kiếm bằng tên hoặc số điện thoại">
        <input style="margin:10px;"  type="submit" name="timkiem" value="Tìm kiếm">
    </form></h2>
</section>
    <?php if(isset($dsdh)&&($dsdh)!=""){
        ...
        echo'<div class="item">  
            ...
            <img style="height:80px" src="'.$case[0]['img'].'" alt="">
            <div class="item-info">
        ...
        if ($dh['trangthai']!='Giao hàng thành công'&&$dh['trangthai']!='Đơn hàng đã bị hủy'){
         echo'  
        <button style="background-color: red;border:none; padding:5px" >
        <a style="text-decoration:none; color: #ffffff" href="addmin.php?act=huydonhang&id='.$dh['id'].'">Hủy đơn hàng</a></button> ';}
if ($dh['trangthai']=='Chờ xác nhận đơn hàng'){ echo'        <button style="background-color: red;border:none; padding:5px" >
            <a style="text-decoration:none; color: #ffffff" href="admin.php?act=giaohang&id='.$dh['id'].'">Bắt đầu giao hàng</a></button> '; }
        if($dh['trangthai']=='Đang giao hàng')echo'
            <button  style="background-color: red;border:none; padding:5px" >
            <a style="text-decoration:none; color: #ffffff" href="admin.php?act=nhandonhang&id='.$dh['id'].'">Khách hàng đã nhận được hàng</a></button>';
        echo'    </p></div>
        </div>';
    }
